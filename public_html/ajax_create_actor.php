...
else { throw_msg(300, $httpReferer, "bunker.php", 17); }
...
else { throw_msg(300, $httpReferer, "bunker.php", 27); }
...
else { throw_msg(300, $httpReferer, "bunker.php", 36); }
...
else { throw_msg(300, $httpReferer, "bunker.php", 43); }
...
else { throw_msg(300, $httpReferer, "bunker.php", 50); }
